...
namespace AiMultiToolKit.FuiImporter
{
    ...
    public static class AiFuiImporter
    {
        ...
        private static void WriteFuiGeneratedRuntimeSupport(string runtimeRoot)
        {
            ...
            var code = @"// Auto-generated by AI Multi-Tool Kit FUI Importer. Keep this file with imported UXML assets.
using UnityEngine.UIElements;

namespace AiMultiToolKit.Generated
{
    public class FuiGradientLabel : Label
    {
        public new class UxmlFactory : UxmlFactory<FuiGradientLabel, UxmlTraits> { }
        public new class UxmlTraits : Label.UxmlTraits
        {
            private readonly UxmlStringAttributeDescription _plainText = new UxmlStringAttributeDescription { name = ""plain-text"", defaultValue = """" };
            private readonly UxmlStringAttributeDescription _gradientName = new UxmlStringAttributeDescription { name = ""gradient-name"", defaultValue = """" };

            public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc)
            {
                base.Init(ve, bag, cc);
                var label = (FuiGradientLabel)ve;
                label.PlainText = _plainText.GetValueFromBag(bag, cc) ?? """";
                label.GradientName = _gradientName.GetValueFromBag(bag, cc) ?? """";
                label.ApplyFuiGradientText();
            }
        }
        ...
        public FuiGradientLabel()
        {
            enableRichText = true;
        }

        private void ApplyFuiGradientText()
        {
            enableRichText = true;
            text = string.IsNullOrEmpty(GradientName)
                ? (PlainText ?? """")
                : ""<color=#FFFFFFFF><gradient=\""" + GradientName + ""\">"" + (PlainText ?? """") + ""</gradient></color>"";
        }
    }

    public class FuiGradientButton : Button
    {
        public new class UxmlFactory : UxmlFactory<FuiGradientButton, UxmlTraits> { }
        public new class UxmlTraits : Button.UxmlTraits
        {
            ...
            {
                base.Init(ve, bag, cc);
                var button = (FuiGradientButton)ve;
                button.PlainText = _plainText.GetValueFromBag(bag, cc) ?? """";
                button.GradientName = _gradientName.GetValueFromBag(bag, cc) ?? """";
                button.ApplyFuiGradientText();
            }
        }
